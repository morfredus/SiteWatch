...
[![Version](https://img.shields.io/badge/version-1.18.10-blue)](CHANGELOG.md)
...
- Contrôle de cohérence entre o2switch, le collecteur et le cache local (métadonnées seulement)
